...
class nnLandmark_trainer(MotorRegressionTrainer_BCEtopK20Loss_moreDA_3_5kep_EDT25):
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        # load jsons 
        name_to_label_path = join(nnUNet_raw, self.plans_manager.dataset_name, 'name_to_label.json')
        spacing_json_path = join(nnUNet_raw, self.plans_manager.dataset_name, 'spacing.json')
        ...
        evaluate_MRE_mm(
            ...
            join(nnUNet_raw, self.plans_manager.dataset_name, 'all_landmarks_voxel.json'),
            join(nnUNet_raw, self.plans_manager.dataset_name, 'spacing.json')
        )
