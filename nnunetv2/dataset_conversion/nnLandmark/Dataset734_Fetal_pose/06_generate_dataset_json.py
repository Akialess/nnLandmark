...
# ------------------------------------------------------------------ paths
root = Path("/home/a332l/dev/Project_SoftDiceLoss/nnunet_data/nnUNet_raw/Dataset734_Fetal_pose")
...
generate_dataset_json(
    ...
    file_ending=".nii.gz", 
    dataset_name="Dataset734_Fetal_pose",                    # human-readable or task ID
    license="hands off!"
)
