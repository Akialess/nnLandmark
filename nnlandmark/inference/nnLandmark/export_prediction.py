...
def convert_predicted_logits_to_segmentation_with_correct_shape(predicted_logits: Union[torch.Tensor, np.ndarray],
    ...
    post_times['resampling_time_seconds'] = time.time() - t0
    ...
    post_times['mask_conversion_time_seconds'] = time.time() - t0
    ...
    post_times['cropping_reverse_time_seconds'] = time.time() - t0
    torch.set_num_threads(old_threads)

    return segmentation_reverted_cropping, predicted_probabilities, post_times
...
def export_prediction_from_logits(predicted_array_or_file: Union[np.ndarray, torch.Tensor],
    ...
    segmentation_final, probabilities_final, times = convert_predicted_logits_to_segmentation_with_correct_shape(
    ...
    times['centroid_extraction_time_seconds'] = time.time() - t0_centroid
