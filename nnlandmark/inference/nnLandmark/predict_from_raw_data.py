...
from nnlandmark.inference.nnLandmark.export_prediction import export_prediction_from_logits, \
    convert_predicted_logits_to_segmentation_with_correct_shape
from nnlandmark.inference.nnLandmark.sliding_window_prediction import compute_gaussian, \
    compute_steps_for_sliding_window

from nnlandmark.utilities.file_path_utilities import get_output_folder, check_workers_alive_and_busy
...
def predict_entry_point():
    ...
    parser.add_argument('-p', type=str, required=False, default='nnUNetPlans',
                        help='Plans identifier. Specify the plans in which the desired configuration is located. '
                             'Default: nnUNetPlans')
    parser.add_argument('-tr', type=str, required=False, default='nnLandmark',
                        help='What nnU-Net trainer class was used for training? Default: nnLandmark')
...
if __name__ == '__main__':
    ...
    # from nnlandmark.paths import nnLM_results, nnLM_raw
    ...
    # )
    # predictor.initialize_from_trained_model_folder(
    #     join(nnLM_results, 'Dataset004_Hippocampus/nnUNetTrainer_5epochs__nnUNetPlans__3d_fullres'),
    #     use_folds=(0,),
    #     checkpoint_name='checkpoint_final.pth',
    # )
    # # predictor.predict_from_files(join(nnLM_raw, 'Dataset003_Liver/imagesTs'),
    # #                              join(nnLM_raw, 'Dataset003_Liver/imagesTs_predlowres'),
    # #                              save_probabilities=False, overwrite=False,
    # #                              num_processes_preprocessing=2, num_processes_segmentation_export=2,
    # #                              folder_with_segs_from_prev_stage=None, num_parts=1, part_id=0)
    # #
    # # # predict a numpy array
    # # from nnlandmark.imageio.simpleitk_reader_writer import SimpleITKIO
    # #
    # # img, props = SimpleITKIO().read_images([join(nnLM_raw, 'Dataset003_Liver/imagesTr/liver_63_0000.nii.gz')])
