...
def main():
    ...
    parser.add_argument("--target", default="/home/a332l/dev/Project_SoftDiceLoss/nnunet_data/nnUNet_raw/Dataset739_Fposev2/imagesAll/", help="Target directory to copy renamed images into")
