...
def main():
    base = Path("/home/a332l/dev/Project_SoftDiceLoss/data/landmark_datasets/pose_dataset")
    vol_dir, anno_dir = base / "volumes", base / "landmark_anno"

    vols  = list(vol_dir.glob("*.nii*"))
    ...
    out_root = Path("/home/a332l/dev/Project_SoftDiceLoss/nnunet_data/nnUNet_raw/Dataset732_Fetal_pose")
